...
mod test {
    ...
    #[test]
    fn continuous_add() {
        let p = Continuous::new(8, "n1".into());
        assert_eq!(
            p,
            vec![Node {
                id: "n1".into(),
        ...
        let (p, mut r) = Continuous::add_node(8, p, "n2".into());
        assert_eq!(
            p,
            vec![
                Node {
        ...
        let (p, mut r) = Continuous::add_node(8, p, "n3".into());
        assert_eq!(
            p,
            vec![
                Node {
        ...
        let (p, mut r) = Continuous::add_node(8, p, "n4".into());
        assert_eq!(
            p,
            vec![
                Node {
    ...
    fn continuous_remove_end() {
        ...
        let (p, mut r) = Continuous::remove_node(8, p, "n4".into());
        assert_eq!(
            p,
            vec![
                Node {
        ...
        let (p, mut r) = Continuous::remove_node(8, p, "n3".into());
        assert_eq!(
            p,
            vec![
                Node {
        ...
        let (p, mut r) = Continuous::remove_node(8, p, "n2".into());
        assert_eq!(
            p,
            vec![Node {
                id: "n1".into(),
    ...
    fn continuous_remove_start() {
        ...
        let (p, mut r) = Continuous::remove_node(8, p, "n1".into());
        assert_eq!(
            p,
            vec![
                Node {
